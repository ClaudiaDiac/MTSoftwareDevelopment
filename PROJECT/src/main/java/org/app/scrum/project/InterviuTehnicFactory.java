...
public class InterviuTehnicFactory {
	...
	public InterviuTehnic buildInterviuTehnic(Integer IDAplicant, String NumeAplicant, Date DataInterviu, String DomeniuInternship,
		...
		for (int i=0; i<=aplicantiCount-1; i++ ){
			aplicantInterviuTehnic.add(new Aplicanti(1001,"Diaconu Diana", new Date(dataAplicare.getTime() + i * interval), 745156487, "dm@gmail.com", "FEAA", 3, "Software Development", new Date(dataAplicare.getTime() + i * interval), "Da", null, itehnic));
		}
